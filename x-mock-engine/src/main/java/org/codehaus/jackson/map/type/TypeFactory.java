...
public final class TypeFactory {
    ...
    public ArrayType constructArrayType(Class<?> elementType) {
        return ArrayType.construct(this._constructType(elementType, (TypeBindings)null), (Object)null, (Object)null);
    }
    ...
    public JavaType constructSimpleType(Class<?> rawType, JavaType[] parameterTypes) {
        ...
        if ( typeVars.length != parameterTypes.length ) {
            ...
            JavaType resultType = new SimpleType( rawType, names, parameterTypes, (Object)null, (Object)null);
            return resultType;
        }
    }
    ...
    protected JavaType _fromClass(Class<?> clz, TypeBindings context) {
        if (clz.isArray()) {
            return ArrayType.construct(this._constructType(clz.getComponentType(), (TypeBindings)null), (Object)null, (Object)null);
        } else if (clz.isEnum()) {
